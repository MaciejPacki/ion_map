...
def TECR_detector(L4):
    ...
    init_tecr1 = (L4[epochs[1]] * TEC_const - L4[epochs[0]] * TEC_const) / (epochs[1]-epochs[0]).seconds
    init_tecr2 = (L4[epochs[2]] * TEC_const - L4[epochs[1]] * TEC_const) / (epochs[2]-epochs[1]).seconds
...
def arc_detector(L4, MWWL):
    ...
    return [common.datetime_to_secs_of_day(i)for i in MWWL_cs], [common.datetime_to_secs_of_day(i) for i in TECR_cs]
